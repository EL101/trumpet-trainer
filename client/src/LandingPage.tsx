...
import { Container, Heading, Flex, Text, Separator, Box, Button } from "@chakra-ui/react";
    ...
    >
      <Flex direction="column" gap={{base:"2rem", md:"14rem"}} height="100%">
        ...
        <Flex direction="column" gap={{base:"1rem", md:"2rem"}}>
          <Heading size={{base:"4xl", md:"5xl", lg:"6xl"}}>Practice with Interactive Exercises and Live Feedback.</Heading>
...
function RightPanel() {
  return (
    <Box flex={{base:"0 1 auto", md:"1"}} bgColor="white" color="black" height="100%" p={{base:"0 4rem 1rem 3rem", md:"3rem 4rem 1rem 3rem"}}>
      <Flex direction="column" height="100%" gap={{base:"4rem", md:"15rem"}}>
        ...
        <Flex direction="column" align="center" width="100%">
          <Heading size={{base:"2xl", md:"3xl"}}>OAUTH</Heading>
